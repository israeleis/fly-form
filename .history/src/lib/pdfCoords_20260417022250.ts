...
export const COORDS: Record<string, FieldBox> = {
  ...
  // The commander row sits lower than the heading underline above it.
  commanderPersonalNumber: { x: 460, y: 335, width:  90, height: 20 },
  commanderRank:           { x: 375, y: 330, width:  75, height: 20 },
  commanderName:           { x: 225, y: 330, width: 150, height: 20 },
  commanderDate:           { x: 125, y: 330, width: 100, height: 20 },
}
