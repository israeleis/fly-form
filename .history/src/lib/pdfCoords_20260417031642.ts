...
export const COORDS: Record<string, FieldBox> = {
  ...
  rank:             { x: 175, y: 658, width:  110, height: 30 },
  travelPurpose:    { x:  20, y: 658, width: 120, height: 30 },
  ...
  contactAddress:   { x: 140, y: 605, width: 80, height: 30, preferWrap: true, maxLines: 2 },
  contactPhone:     { x:  20, y: 605, width: 120, height: 30 },
