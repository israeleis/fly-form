...
export const COORDS: Record<string, FieldBox> = {
  ...
  commanderPersonalNumber: { x: 420, y: 330, width: 42,  height: 15, align: 'right', maxSize: 10 },
  commanderRank:           { x: 363, y: 330, width: 30,  height: 15, align: 'right', maxSize: 10 },
  commanderName:           { x: 268, y: 330, width: 57, height: 15, align: 'right', maxSize: 10 },
  commanderDate:           { x: 178, y: 330, width: 60,  height: 15, align: 'right', maxSize: 10 },
}
