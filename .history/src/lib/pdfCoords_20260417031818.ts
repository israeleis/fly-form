...
export const COORDS: Record<string, FieldBox> = {
  // Section 1 — Row 1
  personalNumber:   { x: 425, y: 658, width: 110, height: 30 },
  lastName:         { x: 345, y: 658, width: 100, height: 30 },
  firstName:        { x: 270, y: 658, width: 100, height: 30 },
  rank:             { x: 140, y: 658, width: 100, height: 30 },
  travelPurpose:    { x:  17, y: 658, width: 123, height: 30 },

  // Section 1 — Row 2 (contact person)
  contactLastName:  { x: 345, y: 605, width: 100, height: 30 },
  contactFirstName: { x: 270, y: 605, width: 100, height: 30 },
  contactAddress:   { x: 140, y: 605, width: 100, height: 30, preferWrap: true, maxLines: 2 },
  contactPhone:     { x:  17, y: 605, width: 123, height: 30 },
