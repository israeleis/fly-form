...
export const COORDS: Record<string, FieldBox> = {
  ...
  commanderPersonalNumber: { x: 385, y: 328, width: 72,  height: 15, align: 'right', maxSize: 10 },
  commanderRank:           { x: 328, y: 328, width: 58,  height: 15, align: 'right', maxSize: 10 },
  commanderName:           { x: 263, y: 328, width: 118, height: 15, align: 'right', maxSize: 10 },
  commanderDate:           { x: 178, y: 328, width: 65,  height: 15, align: 'right', maxSize: 10 },
}
