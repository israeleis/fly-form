...
export const COORDS: Record<string, FieldBox> = {
  ...
  commanderPersonalNumber: { x: 414, y: 330, width: 72,  height: 18, align: 'right', maxSize: 10 },
  commanderRank:           { x: 325, y: 330, width: 58,  height: 18, align: 'right', maxSize: 10 },
  commanderName:           { x: 220, y: 330, width: 118, height: 18, align: 'right', maxSize: 10 },
