...
export const COORDS: Record<string, FieldBox> = {
  ...
  contactLastName:  { x: 345, y: 600, width: 100, height: 30 },
  contactFirstName: { x: 270, y: 600, width: 100, height: 30 },
  contactAddress:   { x: 140, y: 600, width: 80, height: 30, preferWrap: true, maxLines: 2 },
  contactPhone:     { x:  20, y: 600, width: 120, height: 30 },
