...
export const COORDS: Record<string, FieldBox> = {
  // Section 1 — Row 1
  personalNumber:   { x: 435, y: 658, width: 110, height: 35 },
  lastName:         { x: 365, y: 658, width: 100, height: 35 },
  ...
  contactLastName:  { x: 365, y: 598, width: 100, height: 35 },
  contactFirstName: { x: 265, y: 600, width: 100, height: 35 },
  contactAddress:   { x: 130, y: 598, width: 135, height: 35, preferWrap: true, maxLines: 2 },
  contactPhone:     { x:  25, y: 600, width: 105, height: 35 },

  // Section 2 — Trip details
  destinationCountry: { x: 465, y: 523, width: 110, height: 30 },
  departureDate:      { x: 360, y: 523, width: 105, height: 30 },
  returnDate:         { x: 255, y: 523, width: 105, height: 30 },
  stayDays:           { x: 155, y: 523, width: 100, height: 30 },
