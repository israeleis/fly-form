...
export const COORDS: Record<string, FieldBox> = {
  ...
  commanderPersonalNumber: { x: 385, y: 328, width: 72,  height: 18, align: 'right', maxSize: 10 },
  commanderRank:           { x: 328, y: 328, width: 58,  height: 18, align: 'right', maxSize: 10 },
  commanderName:           { x: 210, y: 328, width: 118, height: 18, align: 'right', maxSize: 10 },
  commanderDate:           { x: 145, y: 328, width: 85,  height: 18, align: 'right', maxSize: 10 },
}
