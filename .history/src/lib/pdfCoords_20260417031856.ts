...
export const COORDS: Record<string, FieldBox> = {
  // Section 1 — Row 1
  personalNumber:   { x: 425, y: 660, width: 110, height: 30 },
  lastName:         { x: 345, y: 660, width: 100, height: 30 },
  firstName:        { x: 270, y: 660, width: 100, height: 30 },
  rank:             { x: 140, y: 660, width: 100, height: 30 },
  travelPurpose:    { x:  17, y: 660, width: 123, height: 30 },
